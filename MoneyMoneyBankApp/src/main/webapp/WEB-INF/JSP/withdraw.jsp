	 ...
	 <div class="container">
            ...
            <form action="WithdrawForm">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="acc_no" name="accountNo">
                      </div>
                      <div class="form-group">
                            <label for="amount_withdraw">Amount to Withdraw:</label>
                            <input type="number" class="form-control" id="withdraw_amount" name="amount">
                          </div>
                          <button type="submit" class="btn btn-primary" onclick="boolean">Withdraw</button>
            </form>
        </div>
        <div class="footer">
